  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          name: 'PlaidLinkPage',
          path: 'plaid-link',
          component: () => import('@/views/pages/PlaidLinkPage'),
        },
        {
          name: 'Pricing',
          path: 'pricing',
    ...
    {
      path: '/',
      //component: () => import('@/views/dashboard/tables/ClientTable'),
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('@/views/dashboard/tables/PendingReviewTable'),
        },
